...
urls = Map([
    ...
    Rule('/pets/create/<int:species_id>/', endpoint='pets.create_pet', defaults={'selected_appearance_id': None, 'selected_color': None}),
    Rule('/pets/create/<int:species_id>/<int:selected_appearance_id>/<color:selected_color>', endpoint='pets.create_pet'),
