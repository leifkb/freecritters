...
% elif group.type == 2:
Group types can only be made less restrictive, and there are two types of group less restrictive than a ${group.type_name}. You can turn your group into a ${Group.type_names[group.type-1]} or a ${Group.type_names[group.type-2]} if you would like.
% endif
</p>
