...
forums = Table('forums', metadata,
    ...
    Column('view_permission_id', Integer, ForeignKey('permissions.permission_id', name='fkey__forums__view_permission_id', use_alter=True, ondelete='SET NULL', onupdate='CASCADE')),
    Column('view_special_group_permission_id', Integer, ForeignKey('special_group_permissions.special_group_permission_id', name='fkey__forums__view_special_group_permission_id', use_alter=True, ondelete='SET NULL', onupdate='CASCADE')),
    Column('create_thread_permission_id', Integer, ForeignKey('permissions.permission_id', name='fkey__forums__create_thread_permission_id', use_alter=True, ondelete='SET NULL', onupdate='CASCADE')),
    Column('create_thread_special_group_permission_id', Integer, ForeignKey('special_group_permissions.special_group_permission_id', name='fkey__forums__create_thread_special_group_permission_id', use_alter=True, ondelete='SET NULL', onupdate='CASCADE')),
    Column('create_post_permission_id', Integer, ForeignKey('permissions.permission_id', name='fkey__forums__create_post_permission_id', use_alter=True, ondelete='SET NULL', onupdate='CASCADE')),
    Column('create_post_special_group_permission_id', Integer, ForeignKey('special_group_permissions.special_group_permission_id', name='fkey__forums__create_post_special_group_permission_id', use_alter=True, ondelete='SET NULL', onupdate='CASCADE')),
)
